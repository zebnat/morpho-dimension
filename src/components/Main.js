...
const Main = ({ children }) => (
    <ThemeContext.Consumer>
        {({ theme }) =>
            <main className={`min-h-screen items-center z-0 px-6 py-6 lg:py-10 bg-gray-200 dark:bg-primary_${theme.value}_2 dark:text-white h-auto flex justify-center`}>
